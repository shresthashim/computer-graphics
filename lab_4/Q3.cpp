...
int main()
{
    ...
    // Step 1: Get triangle input and draw immediately
    ...
    // Step 2: Get fixed point and mark it
    ...
    // Step 4: Translate to origin (relative to fixed point)
    ...
    outtextxy(10, 50, "Step 1: Translated to origin - Press any key");
    getch();

    // Step 5: Scale relative to origin
    ...
    outtextxy(10, 70, "Step 2: Scaled relative to origin");
    getch();
